const pic=document.getElementById("pictures");
        ...
        function calculator() {
            ...
            var results= paragraphBox.innerHTML=`
             <p>Name    :       ${nameValue}</p>
        ...
        function sendMail(){
            ...
            const Total= pricePic + priceVid;
           var results= toTal.innerHTML=  ` R${Total}`;
            console.log(nameValue)
            ...
            var params={
                ...
                package_number : document.getElementById("pictures").value,
                package_number : document.getElementById("video").value,
                date : document.getElementById("date").value,
                time : document.getElementById("time").value,
                
                total : document.getElementById("paraa").innerHTML=results
               

            }
            emailjs.send('service_a447ajc','template_2n1u4ma',params).then(function(res){
                alert('email sent! ');
            })
